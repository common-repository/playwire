...
<?php if ( $pagenow == "edit.php" || $pagenow == "post.php" || $pagenow == "post-new.php" ) : ?>
	...
	<?php if ( $video_id ) : ?>
		...
		<script data-config="<?php echo esc_url( '//config.playwire.com/' . rtrim($publisher_id, '/' ) . '/videos/v2/' . rtrim( $video_id, '/' ) . '/zeus.json' ); ?>" data-css="//cdn.playwire.com/bolt/js/zeus/skins/default.css" src="//cdn.playwire.com/bolt/js/zeus/embed.js" type="text/javascript"></script>
	...
	<?php else: ?>
			...
			<div class="playwire-warning warning-text">
				...
				<?php esc_html_e( 'Preview unavailable until you finish uploading a video', 'playwire' ); ?></br></br>
					<a href="http://support.playwire.com/article/wordpress-plugin-documentation/" target="_blank"> &Rightarrow; Click here for help uploading videos</a>
			</div>
